...
#define R__DICTIONARY_FILENAME EDepSimEventsProjectDict
...
#include "EDepSimEventsProjectHeaders.h"
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const pair<string,vector<TG4HitSegment> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("pair<string,vector<TG4HitSegment> >", "string", 96,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<pair<string,vector<TG4HitSegment> > >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<pair<string,vector<TG4HitSegment> > >", -2, "vector", 210,
...
namespace {
  void TriggerDictionaryInitialization_EDepSimEventsProjectDict_Impl() {
    static const char* headers[] = {
"EDepSimEventsProjectHeaders.h",
0
    };
    static const char* includePaths[] = {
"/usr/include/root",
"/afs/cern.ch/user/l/ldinoto/EDEPSIM/edep-sim/tools",
"/afs/cern.ch/user/l/ldinoto/EDEPSIM/edep-sim/tools",
"/usr/share/root",
"/usr/share/root/cling",
"/usr/include/root",
"/usr/include/root",
"/afs/cern.ch/user/l/ldinoto/EDEPSIM/edep-sim/tools/EDepSimEvents/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "EDepSimEventsProjectDict dictionary forward declarations' payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("EDepSimEventsProjectDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_EDepSimEventsProjectDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_EDepSimEventsProjectDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_EDepSimEventsProjectDict() {
  TriggerDictionaryInitialization_EDepSimEventsProjectDict_Impl();
}
